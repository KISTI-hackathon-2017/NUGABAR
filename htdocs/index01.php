...
<nav class="navbar navbar-default">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				<br>
				<input type="button" onclick="div()" value="Find Start Point" class="btn btn-mymy"> 
				<input type="button" onClick="LonLatFromPixel()" value="Find Walkway" class="btn btn-mymy">
			</div>
		</div>
	</div>
	<div>
